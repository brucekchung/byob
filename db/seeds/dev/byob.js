...
exports.seed = (knex, Promise) => {
  return knex('people_strengths').del()
    ...
    .then(() => {
      return knex('strengths').insert([
        ...
        },
        {
          ...
          "strengthsTitle": "Individualization",
        },
        {
    ...
    // .then(() => {
    //   return knex('people_strengths').insert([
    //     {id: 1, people_id: 1, strengths_id: 1},
    //     {id: 2, people_id: 1, strengths_id: 3},
    //     {id: 3, people_id: 1, strengths_id: 2},
    //     {id: 4, people_id: 1, strengths_id: 4},
    //     {id: 5, people_id: 1, strengths_id: 5}
    //   ])
    // })
}
